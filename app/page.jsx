      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            {/* Why use asChild?
              Normally, a <Button> renders as a <button> tag. But since you want the entire button to behave like a <Link> (for navigation), 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((type) => (
              ...
              >
                ...
                {/*  from-black/70 to-transparent :image nte bottom 70% to top transparent */}
